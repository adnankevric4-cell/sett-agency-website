---
title: Long Close School
subtitle: Brand Identity & Website Redesign · Slough, United Kingdom · 2026
services: [Brand Identity, Web Design, WordPress Development]
industry: Independent Education
location: Slough, United Kingdom
year: 2026
website: longcloseschool.co.uk
order: 1
cover: media-1.png
gallery:
  - media-1.png
  - media-2.png
  - pair:media-3.png:media-4.png
  - media-5.png
  - media-6.png
...
summary: Long Close School has shaped students since 1941, but its website did not match its reputation. We rebuilt the brand from the ground up and restructured the site around how prospective families actually move through it, turning a neglected platform into one built to convert.
challenge: "Long Close School has been shaping students since 1941. The philosophy was clear, the community was strong, and the school's reputation spoke for itself. The website did not. There were no documented brand standards, the platform had been structurally neglected, and three distinct school communities shared a single digital home with no coherent logic for prospective parents navigating between them."
